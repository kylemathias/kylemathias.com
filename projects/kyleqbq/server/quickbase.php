<?php
 ...
 -----------------------------------------------------------------------*/
	var $user_name   = 'edbo'; 	// QuickBase user who will access the QuickBase
	var $passwd      = 'sEaBr00K2017$';	// Password of this user
	var $user_token      = 'bmpe6e4qr';	// Valid user token
	var $db_id       = 'bmpe6e4uk'; 	// Table/Database ID of the QuickBase being accessed
	var $app_token   = 'bcsc9wgcrdr4agbqqekhpdbxqx6p';
	var $xml         = true;
	var $user_id     = 0;
